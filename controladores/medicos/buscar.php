                ...
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <?php foreach($medicos as $key => $medico) : ?>
                            ...
                            <td><a class="btn btn-warning w-100" href="/Final_miron/vistas/medicos/modificar.php?med_id=<?= $medico['MED_ID']?>">Modificar</a></td>
                            <td><a class="btn btn-danger w-100" href="/Final_miron/controladores/medicos/eliminar.php?med_id=<?= $medico['MED_ID']?>">Eliminar</a></td>
                        </tr>
                        <?php endforeach ?>
                        <?php else :?>
                            <tr>
